...
const getFaqItems = (): FAQItemData[] => [
	{
		question: t`Is rbuilder really free?`,
		answer: t`Yes! rbuilder is completely free to use, with no hidden costs, premium tiers, or subscription fees. It's open-source and will always remain free.`,
	},
	{
		question: t`How is my data protected?`,
		answer: t`Your data is stored securely and is never shared with third parties. You can also self-host rbuilder on your own servers for complete control over your data.`,
	},
	{
	...
	{
		question: t`What makes rbuilder different from other resume builders?`,
		answer: t`rbuilder is open-source, privacy-focused, and completely free. Unlike other resume builders, it doesn't show ads, track your data, or limit your features behind a paywall.`,
	},
	{
