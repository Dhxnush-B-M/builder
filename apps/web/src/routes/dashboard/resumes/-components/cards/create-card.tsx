	...
	return (
		...
		>
			<div className="absolute inset-0 flex flex-col items-center justify-center gap-3.5 p-4 text-center">
				<div className="relative flex size-20 items-center justify-center rounded-3xl border border-emerald-500/40 bg-gradient-to-tr from-emerald-500/20 via-teal-500/10 to-transparent p-4 shadow-emerald-500/20 shadow-xl backdrop-blur-2xl transition-all duration-500 group-hover:scale-115 group-hover:border-emerald-400 group-hover:bg-emerald-500/30">
					<PlusIcon
						weight="bold"
						className="size-10 text-emerald-400 transition-transform duration-500 group-hover:rotate-90"
					/>
					<SparkleIcon className="absolute -top-2 -right-2 size-5 animate-pulse text-emerald-400" />
				</div>
