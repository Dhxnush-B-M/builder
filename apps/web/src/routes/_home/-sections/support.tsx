...
const flyingLogos = [
	{ id: "1", name: "PDF Engine", icon: LightningIcon, color: "text-amber-400", glow: "shadow-amber-500/20", delay: "0s" },
	{ id: "2", name: "ATS Parser", icon: ShieldCheckIcon, color: "text-emerald-400", glow: "shadow-emerald-500/20", delay: "0.5s" },
	{ id: "3", name: "Local DB", icon: DatabaseIcon, color: "text-blue-400", glow: "shadow-blue-500/20", delay: "1s" },
	{ id: "4", name: "Custom Styling", icon: PaletteIcon, color: "text-purple-400", glow: "shadow-purple-500/20", delay: "1.5s" },
	{ id: "5", name: "Global Fonts", icon: GlobeIcon, color: "text-pink-400", glow: "shadow-pink-500/20", delay: "2s" },
	{ id: "6", name: "Fast Render", icon: CpuIcon, color: "text-indigo-400", glow: "shadow-indigo-500/20", delay: "2.5s" },
	{ id: "7", name: "Multi-Resume", icon: FileTextIcon, color: "text-teal-400", glow: "shadow-teal-500/20", delay: "3s" },
	...
	{ id: "10", name: "Smart Import", icon: SparkleIcon, color: "text-yellow-400", glow: "shadow-yellow-500/20", delay: "4.5s" },
];
...
export function Support() {
	return (
		<section id="support" className="relative overflow-hidden border-border/40 border-b py-20 md:py-28">
			...
			<div aria-hidden="true" className="pointer-events-none absolute inset-0 flex items-center justify-center opacity-25">
