...
const repositoryUrl = "https://github.com/Dhxnush-B-M/builder";
...
export const createRootStructuredDataScript = (canonicalUrl: string) =>
	createStructuredDataScript("rbuilder-structured-data", {
...
const homeFaqJsonLdItems = [
	{
		...
		answer:
			"Yes! rbuilder is completely free to use, with no hidden costs, premium tiers, or subscription fees. It will always remain free.",
	},
	{
		question: "How is my data protected?",
		answer:
			"Your data is stored securely and is never shared with third parties. You have complete control over your data.",
	},
	{
	...
	},
	{
		...
		answer:
			"rbuilder is privacy-focused and completely free. Unlike other resume builders, it doesn't show ads, track your data, or limit your features behind a paywall.",
	},
	{
